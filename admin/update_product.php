...
<section class="update-product">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <input type="text" required placeholder="entrez le nom du produit" name="name" maxlength="100" class="box" value="<?= $fetch_products['name']; ?>">
      <span>mettre à jour le prix</span>
      <input type="number" min="0" max="9999999999" required placeholder="saisir le prix du produit" name="price" onkeypress="if(this.value.length == 10) return false;" class="box" value="<?= $fetch_products['price']; ?>">
      <span>mettre à jour la catégorie</span>
      <select name="category" class="box" required>
         <option selected value="<?= $fetch_products['category']; ?>"><?= $fetch_products['category']; ?></option>
         <option value="main dish">plat principal</option>
      ...
      <div class="flex-btn">
         <input type="submit" value="mise à jour" class="btn" name="update">
